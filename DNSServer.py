...
def run_dns_server():
    # REVERTED TO PORT 53. The Gradescope test environment is querying port 53.
    # The IP remains 127.0.0.1 for the local DNS query in the testing environment.
    DNS_IP = '127.0.0.1'
    DNS_PORT = 53
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    if isinstance(answer_data, str):
                        ...
                        # Handle TXT records, which are tuples of strings
